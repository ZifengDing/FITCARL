...
ent2sec = np.load('/mnt/data1/ma/OOG_TKG/openreview/dataset/ICEWS14/auxiliary/ent2sec_matrix_v1.npy')
print(ent2sec.shape)
rel_prob = {}
rel_count = {}
relations = set()

with open('/mnt/data1/ma/TITer-master/data/ICEWS14/processed_data_v1/background_graph_for_rl.txt', 'r') as f:
    for line in f:
...
rel_prob.update({230:[torch.zeros(1, ent2sec.shape[1]), torch.zeros(1, ent2sec.shape[1])]})
rel_count.update({230: 1})
softmax = torch.nn.Softmax(dim=1)
rel2secprob = []
for rel in range(0, 230):
...
with open('/mnt/data1/ma/TITer-master/data/ICEWS14/processed_data_v1/rel2secprob.pickle', 'wb') as handle:
