...
ent2sec = np.load('/mnt/data1/ma/OOG_TKG/Dataset/ICEWS05-15/auxiliary/ent2sec_matrix_v3.npy')
print(ent2sec.shape)
rel_prob = {}
rel_count = {}
relations = set()

with open('/mnt/data1/ma/TITer-master/data/ICEWS05-15/processed_data_v5/background_graph_for_rl.txt', 'r') as f:
    for line in f:
...
with open('/mnt/data1/ma/TITer-master/data/ICEWS05-15/processed_data_v5/rel2secprob.pickle', 'wb') as handle:
